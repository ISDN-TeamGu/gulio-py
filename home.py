...
• Do not give the options with any characters, always give the options with this format: [options]["Go find Dumbledore for advices"][options]["Meet up with Ron and Hermione"][options]["Search for clues alone"]. 
"""
lines = [
